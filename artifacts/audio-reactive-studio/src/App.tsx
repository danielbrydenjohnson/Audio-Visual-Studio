    ...
    <div className="h-[100dvh] w-full bg-background text-foreground flex flex-col overflow-hidden font-sans selection:bg-primary/30">
      ...
      <header className="h-14 border-b border-border/60 flex items-center px-6 shrink-0 bg-background z-20">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-semibold text-sm tracking-wide text-foreground">Audio Reactive Studio</h1>
        </div>
      </header>
      ...
      <main className="flex-1 flex overflow-hidden">
        {/* Preview Area */}
        <section className="flex-1 flex flex-col bg-muted/10 p-6 relative isolate">
          {/* Subtle grid background pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] -z-10" />
          
          <div className="flex-1 border border-border/40 rounded-xl bg-black/40 shadow-2xl flex items-center justify-center relative overflow-hidden backdrop-blur-sm">
            {/* Corner accents */}
            ...
            <div className="flex flex-col items-center gap-3 opacity-60">
              <span className="text-muted-foreground font-mono text-sm uppercase tracking-[0.2em]">Canvas Preview</span>
              <span className="text-[10px] text-muted-foreground/60 font-mono">1920 × 1080</span>
            </div>
          </div>
        </section>
        ...
        <aside className="w-[300px] border-l border-border/60 bg-card flex flex-col shrink-0 overflow-hidden relative z-10 shadow-xl">
          <div className="h-14 border-b border-border/60 flex items-center px-5 shrink-0 bg-card">
            <h2 className="font-medium text-[11px] tracking-[0.15em] uppercase text-muted-foreground">Controls</h2>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="h-28 rounded-lg border border-border/40 bg-muted/20 flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-[11px] text-muted-foreground font-medium">Shape & Geometry</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="h-36 rounded-lg border border-border/40 bg-muted/20 flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-[11px] text-muted-foreground font-medium mt-1">Palette & Effects</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="h-20 rounded-lg border border-border/40 bg-muted/20 flex items-center justify-center">
                <span className="text-[11px] text-muted-foreground font-medium">Resolution & Export</span>
              </div>
            </div>
          </div>
        </aside>
